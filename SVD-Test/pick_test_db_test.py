...
class TestDBPicker(unittest.TestCase):
    ...
    def test_trim_cols(self):
        m1 = lil_matrix(numpy.array([[1,2,0],[3,5,0]]))
        m2 = lil_matrix(numpy.array([[1,0,1],[0,0,0]]))
